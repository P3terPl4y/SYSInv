...
import ro.alexmamo.roomjetpackcompose.data.dao.BookDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `book_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `author` TEXT NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '2b496511d65cf8a15ba8628b7cd3de2e')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsBookTable = new HashMap<String, TableInfo.Column>(3);
        ...
        if (!_infoBookTable.equals(_existingBookTable)) {
          return new RoomOpenHelper.ValidationResult(false, "book_table(ro.alexmamo.roomjetpackcompose.domain.model.Book).\n"
                  + " Expected:\n" + _infoBookTable + "\n"
                  + " Found:\n" + _existingBookTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "2b496511d65cf8a15ba8628b7cd3de2e", "f03dfb726c850c0d4637f6e3e1d63f0c");
